...
Returns a value representing the percentile of a value and a given input. Value does not have to be in the input, a Z-score calculation and lookup occurs.
```
```
...
Returns a value representing the Z-score of the mean and standard deviaiton.
```
```

### Z-score percentile
Returns a value representing the percentile of a given Z-score.
```
```